...
pub trait IHashTableBlockPage<const KEY_SIZE: usize, const VALUE_SIZE: usize, KeyType: BytesSerialize<KEY_SIZE>, ValueType: BytesSerialize<VALUE_SIZE>> {
    ...
    fn put_slot(&mut self, offset: usize, key: KeyType, value: ValueType) -> Result<(), HashTableBlockError>;
